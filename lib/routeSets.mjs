...
import assistantResponsesHandler from "../api/assistant-responses.js";
...
import adminTierlistsHandler from "../api/admin-tierlists.js";
...
import internalChatChannelAccessHandler from "../api/internal-chat-channel-access.js";
import internalChatMessagesHandler from "../api/internal-chat-messages.js";
import internalChatModerationHandler from "../api/internal-chat-moderation.js";
import latestStatsSnapshotHandler from "../api/latest-stats-snapshot.js";
import publicTierlistsHandler from "../api/public-tierlists.js";
import streamerTierlistsHandler from "../api/streamer-tierlists.js";
...
import userChatBansHandler from "../api/user-chat-bans.js";
import userChatAttachmentsHandler from "../api/user-chat-attachments.js";
import userChatChannelsHandler from "../api/user-chat-channels.js";
import userLogoutHandler from "../api/user-logout.js";
import userChatAuthHandler from "../api/user-chat-auth.js";
import userChatGroupsHandler from "../api/user-chat-groups.js";
import userChatInvitesHandler from "../api/user-chat-invites.js";
import userChatMembersHandler from "../api/user-chat-members.js";
import userChatModerationHandler from "../api/user-chat-moderation.js";
import userChatMessagesHandler from "../api/user-chat-messages.js";
import userAvatarHandler from "../api/user-avatar.js";
import userProfileHandler from "../api/user-profile.js";
import userStreamerTierlistsHandler from "../api/user-streamer-tierlists.js";
...
import quizMediaUploadHandler from "../api/quiz-media-upload.js";
import { quizDetailRoute } from "../api/quiz-router.js";
import { isAuthGatewayPath } from "./gatewayRouting.mjs";

export const publicRoutes = new Map([
  ["/api/assistant/responses", assistantResponsesHandler],
  ["/api/assistant/tasks", assistantResponsesHandler],
  ["/api/assistant/sync", assistantResponsesHandler],
  ["/api/assistant/tips/sync", assistantResponsesHandler],
  ...
  ["/api/public-tierlists", publicTierlistsHandler],
  ["/api/streamer-tierlists", streamerTierlistsHandler],
...
export const authRoutes = new Map([
  ...
  ["/api/admin/tierlists", adminTierlistsHandler],
  ...
  ["/api/health", healthHandler],
  ["/api/internal/chat/channels/access", internalChatChannelAccessHandler],
  ["/api/internal/chat/messages", internalChatMessagesHandler],
  ["/api/internal/chat/moderation", internalChatModerationHandler],
  ["/api/quizzes", quizzesHandler],
  ["/api/quizzes/media-upload", quizMediaUploadHandler],
  ["/api/user/chat/bans", userChatBansHandler],
  ["/api/user/chat/attachments", userChatAttachmentsHandler],
  ["/api/user/chat/channels", userChatChannelsHandler],
  ["/api/user/chat/invites", userChatInvitesHandler],
  ["/api/user/logout", userLogoutHandler],
  ["/api/user/chat-auth", userChatAuthHandler],
  ["/api/user/chat/members", userChatMembersHandler],
  ["/api/user/chat/moderation", userChatModerationHandler],
  ["/api/user/chat/groups", userChatGroupsHandler],
  ["/api/user/chat/messages", userChatMessagesHandler],
  ["/api/user/avatar", userAvatarHandler],
  ["/api/user/profile", userProfileHandler],
  ["/api/user/streamer-tierlists", userStreamerTierlistsHandler],
